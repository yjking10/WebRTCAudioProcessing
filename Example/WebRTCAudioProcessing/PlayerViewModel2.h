...
@interface PlayerViewModel2 : NSObject

@property (nonatomic, assign) BOOL isPlaying;
@property (nonatomic, assign) BOOL isPlayerReady;
@property (nonatomic, assign) NSInteger playbackRateIndex;
@property (nonatomic, assign) NSInteger playbackPitchIndex;
...
@property (nonatomic, strong, readonly) NSArray<PlaybackValue *> *allPlaybackRates;
@property (nonatomic, strong, readonly) NSArray<PlaybackValue *> *allPlaybackPitches;
